    ...
    <div class="card shadow" style="width:100%;max-width:450px;">
        <div class="card-body p-5">
            ...
            <form method="POST" action="<?= $baseUrl ?>/app/controllers/UserController.php">
                ...
                <button type="submit" name="register" value="1" class="btn btn-success w-100">S'inscrire</button>
            </form>
            <p class="text-center mt-3 mb-0">Déjà un compte ? <a href="login.php">Se connecter</a></p>
        </div>
    </div>
</div>
